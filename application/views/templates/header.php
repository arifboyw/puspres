...
<head>
    ...
    <title>Puspres | <?= $title ?></title>
    <link href="<?= base_url(); ?>assets/vendor/dist/img/unp.png" alt="KIP Kuliah UNP" rel="shortcut icon">

    <!-- dropzonejs -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/vendor/plugins/dropzone/min/dropzone.min.css">
    <!-- DataTables -->
    ...
    <!-- bs Stepper -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/plugins/bs-stepper/css/bs-stepper.min.css">
</head>
