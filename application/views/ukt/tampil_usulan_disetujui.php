<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                <form action="<?= base_url('ukt/tampil_usulan_disetujui/'); ?>" method="GET">
                    <table width="100%">
                        <tr>
                            <td>
                ...
                <hr>
                Daftar Usulan UKT/SPP yang disetujui sebagai berikut:
                    ...
                    <tbody>
                        ...
                        foreach ($usulan as $v) : ?>
                            <tr>
                                ...
                                <td>
                                    <?= $v->ket_bebas_ukt; ?> untuk semester <b><?= $v->nama_semester_bu; ?></b>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
