    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <br>
                <hr>
                <div class="mb-3 text-center"><strong>File Informasi</strong></div>
                <div class="text-center"><object data="<?= base_url(); ?>/assets/upload/info/<?= $detail_informasi->nama_berkas; ?>" width="999" height="500"></object>
                </div>
                <hr>
                <div class="row">
                    <div class="col-12">
                        <button class="btn btn-primary btn-block" onclick="window.location.assign('<?= base_url(); ?>informasi/daftar_informasi')">
