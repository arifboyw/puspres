                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                                                ...
                                                <div class="card-body">
                                                    <table>
                                                        <tr>
                                                            <td>Nama</td>
                                                            <td>:</td>
                                                            <td><?= $opt_fakultas->name; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Jabatan</td>
                                                            <td>:</td>
                                                            <td><?= $opt_fakultas->jabatan; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Unit</td>
                                                            <td>:</td>
                                                            <td><?= $opt_fakultas->unit; ?></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                                    <?= form_open_multipart('optfakultas/edit'); ?>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                                    <form action="<?= base_url('optfakultas/changepassword'); ?>" method="post">
